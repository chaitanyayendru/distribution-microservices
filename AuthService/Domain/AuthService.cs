...
namespace AuthService.Domain
{
    ...
    {
        private readonly IProductAgents agents;
        private readonly AppSettings appSettings;
        
        public AuthService(IProductAgents agents, IOptions<AppSettings> appSettings)
        {
            this.agents = agents;
        ...
        public ProductAgent AgentFromLogin(string login)
        {
